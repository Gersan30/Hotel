    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
                        <a href="../index.php"><i class="fa fa-dashboard"></i> Pagina web</a>
                    </li>
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Check in
</a>
                    </li>
                    <li>
                    ...
                    <li>
                    <li>
                        <a href="settings.php"><i class="fa fa-gear fa-fw"></i> Ver habiacion
</a>
                    </li>
                    <li>
                        <a  href="payment.php"><i class="fa fa-qrcode"></i> Caja</a>
                    </li>
                    <li>
                        <a href="usersetting.php"><i class="fa fa-user fa-fw"></i>Usuarios</a>
                    </li>
                    <li>
                        <a  class="active-menu" href="profit.php"><i class="fa fa-qrcode"></i> Estadisticas</a>
                    </li>
                    <li>
